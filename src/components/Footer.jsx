          ...
          <div className="sec1">
            <section className="sec2">
              ...
              <section className="selector">
                <div className="India">
                  ...
                  <p>India</p>
                  <i className="fa-solid fa-chevron-down" style={{ color: '#000000' }}></i>
                </div>
            ...
            <div className="main-footer">
              ...
              <div className="foot5">
                <h6>SOCIAL LINKS</h6>
                <div className="icons">
                  <a target="_blank" href="#"><i className="fa-brands fa-linkedin" style={{ color: '#000000' }}></i></a>
                  <a target="_blank" href="#"><i className="fa-brands fa-instagram" style={{ color: '#000000' }}></i></a>
                  <a target="_blank" href="#"><i className="fa-brands fa-twitter" style={{ color: '#000000' }}></i></a>
                  <a target="_blank" href="#"><i className="fa-brands fa-youtube" style={{ color: '#000000' }}></i></a>
                  <a target="_blank" href="#"><i className="fa-brands fa-facebook" style={{ color: '#000000' }}></i></a>
                </div>
